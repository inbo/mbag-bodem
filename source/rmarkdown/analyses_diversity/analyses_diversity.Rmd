...
In `mbag_combined_dataframe_INBO_known_species_v18` zitten de nulwaarnemingen in en deze nulwaarnemingen hebben een shannon en simpson index score van 0 gekregen, wat betekent dat deze nulwaarnemingen dezelfde Shannon en Simpson indexscore krijgen als plots waarin slechts één soort werd waargenomen, wat op het eerste gezicht verdedigbaar lijkt, aangezien de onzekerheid (Shannon) en dominantie (Simpson) in beide gevallen minimaal zijn?
