...
# Compute all pairwise contrasts between land use categories, per depth
contrasts_landuse_by_depth_incl_fyschem <- marginaleffects::comparisons(
  model = lowest_aic,
  variables = "landgebruik",
  newdata = data_subset,
  type = "response",
...
# Print result
print(contrasts_landuse_by_depth_incl_fyschem, n = Inf)
```
...
print(contrasts_landuse_by_depth_incl_fyschem_adj, n = Inf)
