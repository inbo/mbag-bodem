...
# Estimated marginal means per land use
emmeans_landuse <- marginaleffects::avg_predictions(
  m_richness,
...
# Pairwise contrasts between land use types
contrasts_landuse <- marginaleffects::comparisons(
  m_richness,
  variables = "landgebruik",
  newdata = data_subset,
  type = "response"
