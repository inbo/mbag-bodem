...
# Compute pairwise contrasts
contrasts_landuse_by_depth_response <- contrast(emm_landuse_by_depth, method = "pairwise", adjust = "none") %>%
  as.data.frame()
...
# Compute pairwise contrasts
contrasts_landuse_by_depth_incl_fyschem <- contrast(emm_landuse_by_depth, method = "pairwise", adjust = "none") %>%
  as.data.frame()
