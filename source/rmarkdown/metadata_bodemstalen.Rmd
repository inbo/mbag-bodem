...
```{r inlezen}
mbag_shared_drive <- "G:/Gedeelde drives/PRJ_MBAG" # nolint
...
filepath <-
  file.path(
    "Z:",
    "Projects/PRJ_MBAG/4c_bodembiodiversiteit/steekproef/MBAG_eDNA_sampling"
  )
...
landbouwstreken <- read_sf(
  "S:/Vlaanderen/Landbouw/Landbouwstreken_België/Lbstrbel.shp" # nolint
) %>%
  janitor::clean_names() %>%
  st_transform(crs = 31370)
